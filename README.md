...
After install, just ask. The skill walks your agent through CLI install, login, base creation, your first collection, the preview→production flow, and connecting production agents.
