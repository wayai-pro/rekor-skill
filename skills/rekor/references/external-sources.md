...
Deep grammar for the external sources that back a collection with an external API. The SKILL.md **External Sources** section covers the concept and the menu of what a source can declare; read this file when you actually configure one.
